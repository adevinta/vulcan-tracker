...
func setupSubTest(t *testing.T, transitions map[string][]model.Transition) {
	...
	tickets["TEST-1"] = &model.Ticket{
		...
		Description: common.GenerateDescriptionText("Description TEST-1", "4c24526d-2651-4873-8024-b27361b69723", "ff9d5142-0eb3-494a-8626-a72b7182cdb2"),
		Project:     "TEST",
		Status:      ToDo,
	...
	tickets["TEST-2"] = &model.Ticket{
		...
		Description: common.GenerateDescriptionText("Description TEST-2", "4c24526d-2651-4873-8024-b27361b69723", "ff9d5142-0eb3-494a-8626-a72b7182cdb2"),
		Project:     "TEST",
		Status:      InProgress,
		TicketType:  "Vulnerability",
	...
	tests := []struct {
	...
	}{
		{
			...
			want: &model.Ticket{
				...
				FindingID:   "fcafb55e-f8d4-4a10-b073-149b84554b94",
				Summary:     "Summary New Ticket",
				Description: common.GenerateDescriptionText("Description New Ticket", "fcafb55e-f8d4-4a10-b073-149b84554b94", "11c2c999-14a4-434f-ab02-107e2cc14324"),
				Project:     "TEST",
				Status:      ToDo,
				TicketType:  "Vulnerability",
			},
